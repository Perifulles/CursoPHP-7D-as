...
<head>
    ...
    <style>
        * {
        ...
        .day:hover {
            border-color: #1A237E;
            box-shadow: 0 4px 20px rgba(26, 35, 126, .12)
        }
        ...
        #zip-modal .zip-steps li:last-child {
            border: none
        }

        #zip-modal .zip-highlight {
            background: #e8f5e9;
        ...
        #zip-modal .btn-zip-go:hover {
            background: #2e7d32
        }

        #zip-modal .modal-close-zip {
            position: absolute;
            top: 12px;
            right: 16px;
            background: none;
        ...
        #zip-modal .modal-close-zip:hover {
            color: #333
        }
        ...
        #drive-modal .drive-features {
            list-style: none;
            padding: 0;
            margin: 0 0 22px
        }

        #drive-modal .drive-features li {
            padding: 5px 0;
            color: #333;
            font-size: .92em;
            border-bottom: 1px solid #f0f0f0
        ...
        #drive-modal .drive-features li:last-child {
            border: none
        }

        #drive-modal .btn-drive-go {
            display: inline-flex;
            align-items: center;
            gap: 8px;
            background: #1a73e8;
        ...
        #drive-modal .btn-drive-go:hover {
            background: #1558b0;
            text-decoration: none
        }
